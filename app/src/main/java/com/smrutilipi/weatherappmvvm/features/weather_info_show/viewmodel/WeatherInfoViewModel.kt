package com.smrutilipi.weatherappmvvm.features.weather_info_show.viewmodel
...
import com.smrutilipi.weatherappmvvm.utils.kelvinToCelsius
import com.smrutilipi.weatherappmvvm.utils.unixTimestampToDateTimeString
import com.smrutilipi.weatherappmvvm.utils.unixTimestampToTimeString
...
class WeatherInfoViewModel : ViewModel() {
     ...
     */
    fun getWeatherInfo(citylat: Double,citylong:Double, model: WeatherInfoShowModel) {

        progressBarLiveData.postValue(true) // PUSH data to LiveData object to show progress bar

        model.getWeatherInfo(citylat,citylong, object :
